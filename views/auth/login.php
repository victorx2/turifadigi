            ...
            <div class="row">
              <div class="col-xl-6 col-lg-6">
                <div class="contact-two__input-box">
                  <input type="text" name="name" placeholder="Nombre del usuario" title="El nombre del usuario es requerido" required="">
                </div>
              </div>
              <div class="col-xl-6 col-lg-6">
                <div class="contact-two__input-box">
                  <input type="text" name="password" placeholder="Contraseña" title="La contraseña es requerida" required="">
                </div>
              </div>
              <div class="col-xl-6 col-lg-6">
              </div>
