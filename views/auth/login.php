    ...
    <div class="row">
      <div class="col-xl-8">
        <div class="contact-two__left">
          ...
          <p class="contact-two__left-text">Ya tienes una cuenta? <a href="/TuRifadigi/login2">Inicia sesión</a></p>
    ...
    fetch('/TuRifadigi/registro_usuario', {
      ...
      .then(data => {
        if (data.success) {
          ...
          setTimeout(() => {
            window.location.href = '/TuRifadigi/login2'; // Redirige después de 3 segundos
          }, 3000);
        } else {
